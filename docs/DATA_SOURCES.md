...
| Espécies ameaçadas | IUCN Spatial Data + Red List API v4 + GBIF | https://www.iucnredlist.org/ | Shapefile + REST | ✅ oficial (parcial) | 25 espécies-bandeira. **11 com polígonos oficiais IUCN** (