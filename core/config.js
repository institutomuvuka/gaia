...
export const LAYERS = Object.freeze({
  'conservation-units': {
    ...
    icon: '🌳',
    description: 'Unidades de conservação federais e estaduais cadastradas no CNUC.',
    source: {
      origin: 'CNUC / MMA',
      url: 'https://dados.mma.gov.br/dataset/unidades-de-conservacao',
      lastFetched: '2026-04-30',
      ingestionStatus: 'sample',
    },
    sensitivity: 'public',
    color: '#2F9362',
  ...
  'indigenous-lands': {
    ...
    icon: '🪶',
    description: 'Terras indígenas em diferentes estágios de regularização.',
    source: { origin: 'FUNAI / ISA', url: 'https://terrasindigenas.org.br/', ingestionStatus: 'pending' },
    sensitivity: 'public',
    color: '#C68B47',
    visibleByDefault: false,
    module: null, // a implementar
  },
